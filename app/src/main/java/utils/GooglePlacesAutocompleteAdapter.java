...
public class GooglePlacesAutocompleteAdapter extends ArrayAdapter implements Filterable {
    private  final String TAG = "PlacesAutocomplete ";
    private ArrayList resultList;
    // isOnlyCity = true thì chỉ hiển thành phố
    private boolean isOnlyCity ;

    public GooglePlacesAutocompleteAdapter(Context context, int textViewResourceId,boolean city) {
